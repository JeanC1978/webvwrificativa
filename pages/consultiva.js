...
export default function Consultiva() {
	return (
		<Layout>
			...
			/>
			<SectionOurSolutions
				title={SECTION_SOLUTIONS_TITLE}
				subtitle={SECTION_SOLUTIONS_SUBTITLE}
				description={SECTION_SOLUTIONS_DESCRIPTION}
			/>
			<TabVertical title={TITLE} defaultActiveKey="attention">
				<Tab eventKey="attention" title="Atención al Cliente">
					<div className="attention-client-tab">
						<TabContainer
							navItems={ATTENTION_CLIENT_ITEMS}
							buttonText="Comunícate con un asesor"
							id="attention-client-tabs"
