...
export function SectionOurSolutions({
	title,
	subtitle = null,
	description,
	card = null,
			...
			{card && (
				<div className="section-our-solutions__card">
					...
					<div className="section-our-solutions__card__text">
						<p>
							Nuestros servicios se encuentran contemplados dentro de nuestro
							Marco Jurídico basado en la{' '}
							<b>Ley Protección de Datos Personales Nº 29733</b> como respaldo y
							garantía para protección de nuestros clientes.
						</p>
					</div>
				</div>
			)}
