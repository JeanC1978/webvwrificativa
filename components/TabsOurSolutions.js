...
export function TabsOurSolutions(props) {
	...
	return (
		<div className="container-our-solutions">
			...
			<Tabs defaultActiveKey="profile" id="ourSolutions" className="mb-3">
					...
					<div className="tab-content">
						<div className="tab-content__description">
							<div className="tab-content__description__info">
								<h4>
									"Creando sinergia entre las personas, el talento y la
									tecnología"
								</h4>
								<p>
									Plataforma digital para tus procesos de selección,
									verificación y evaluación de personas
								</p>
					...
					<div className="tab-content">
						<div className="tab-content__description">
							<div className="tab-content__description__info">
								...
								<p>
									Potenciamos a tu colaboradores, entrenandolos para ser mas
									competitivos sumando valor a tu marca
								</p>
								<div className="tab-content__description__links"></div>
					...
					<div className="tab-content">
						<div className="tab-content__description">
							<div className="tab-content__description__info">
								...
								<p>
									Plataforma tecnológica con IA especializada en reclutamiento
									masivo de personal operario
								</p>
								<div className="tab-content__description__links"></div>
								<Link href="/consultiva">
									<Image src={SeeMoreSvg} alt="ver más" />
